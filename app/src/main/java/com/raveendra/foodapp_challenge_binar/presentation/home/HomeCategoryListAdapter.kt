...
import com.raveendra.foodapp_challenge_binar.databinding.ItemMenuCategoryBinding

class HomeCategoryListAdapter(
    private val onItemClick: (CategoryViewParam) -> Unit
) : RecyclerView.Adapter<ViewHolder>() {

    private val differ = AsyncListDiffer(this, object : DiffUtil.ItemCallback<CategoryViewParam>() {
        override fun areItemsTheSame(oldItem: CategoryViewParam, newItem: CategoryViewParam): Boolean {
            return oldItem.nama == newItem.nama
        }

        override fun areContentsTheSame(oldItem: CategoryViewParam, newItem: CategoryViewParam): Boolean {
